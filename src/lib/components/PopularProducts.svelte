...
{#snippet productCard(content, index)}
    <a href={'/catalog/' + content.seo.slug} aria-label="product card" class="flex flex-col flex-shrink-0 flex-grow-0 gap-5 max-sm:w-2/3 max-sm:gap-3 pb-1" class:col-span-2={index === 0} class:row-span-2={index === 0}>
