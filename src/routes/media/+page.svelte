...
{#snippet mediaElement(content)}
    ...
    >
        <img class="rounded" src={data.CMS_URL + content.thumbnail.url} width={content.thumbnail.width} height={content.thumbnail.height} alt={content.thumbnail.alternativeText}>
